    ...
    <div class="product-item-wrap has-post-thumbnail">
        <div class="product-item-inner">
            <div class="product-thumb">
                ...
                <div class="product-thumb-primary"><img width="300" height="400" src="{{asset('assets/images/demo/tab-1.jpg')}}" alt="42" title="42" class="attachment-shop_catalog size-shop_catalog wp-post-image"/></div>
                <div class="product-thumb-secondary"><img width="300" height="400" src="{{asset('assets/images/demo/tab-1.jpg')}}" alt="47" class="attachment-shop_catalog size-shop_catalog"/></div><a href="{{ route('shop.show', $product->slug) }}" class="product-link">
